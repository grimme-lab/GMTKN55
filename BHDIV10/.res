...
$tmer {ed,ts}2/$f  x -1 1 $w 56.955 # B-N dewar benzene formation (W3)
...
$tmer {ed,ts}8/$f  x -1 1 $w 50.096 # C2H2 trimer. to benzene (W3)
$tmer {ed,ts}9/$f  x -1 1 $w 65.559 # 1,3-silylshift in allylsilane (W3)
...
# # # W3Lite-F12 from J. Phys. Chem. A (2019) 123 (31): 6720–6732. (doi:10.1021/acs.jpca.9b04611)
