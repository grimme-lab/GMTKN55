...
# Original W2-F12 values from GMTKN55
# W4 values from DBH24-W4 (J. Phys. Chem. A (2008) 112 (50): 12868–12886. (doi:10.1021/jp801805p)
$tmer  h/$f  n2o/$f  n2ohts/$f  x  -1  -1  1  $w         17.19  # W4
$tmer  oh/$f  n2/$f  n2ohts/$f  x  -1  -1  1  $w         82.14  # W4
$tmer  h/$f  hf/$f  hfhts/$f  x  -1  -1  1  $w  42.1
$tmer  hf/$f  h/$f  hfhts/$f  x  -1  -1  1  $w  42.1
$tmer  h/$f  hcl/$f  hclhts/$f  x  -1  -1  1  $w         17.60  # W4
$tmer  hcl/$f  h/$f  hclhts/$f  x  -1  -1  1  $w         17.60  # W4
...
$tmer  ch3/$f  clf/$f  ch3fclts/$f  x  -1  -1  1  $w      6.90  # W4
$tmer  ch3f/$f  cl/$f  ch3fclts/$f  x  -1  -1  1  $w     59.33  # W4
...
$tmer  clch3clcomp/$f  clch3clts/$f x  -1  1    $w       13.53  # W4
$tmer  clch3clcomp/$f  clch3clts/$f x  -1  1    $w       13.53  # W4
$tmer  f-/$f  ch3cl/$f  fch3clts/$f x  -1  -1  1  $w  -12.3
$tmer  cl-/$f  ch3f/$f  fch3clts/$f x  -1  -1  1  $w  19.8
$tmer  fch3clcomp1/$f  fch3clts/$f x  -1  1    $w         3.50  # W4
$tmer  fch3clcomp2/$f  fch3clts/$f x  -1  1    $w        29.53  # W4
$tmer  oh-/$f  ch3f/$f  hoch3fts/$f x  -1  -1  1  $w     -2.40  # W4
$tmer  ch3oh/$f  f-/$f  hoch3fts/$f x  -1  -1  1  $w     17.77  # W4
$tmer  hoch3fcomp2/$f  hoch3fts/$f x  -1  1    $w  11.0
$tmer  hoch3fcomp1/$f  hoch3fts/$f x  -1  1    $w  47.7
$tmer  h/$f  n2/$f  hn2ts/$f   x  -1  -1  1  $w          14.32  # W4
$tmer  hn2/$f  hn2ts/$f    x  -1  1    $w                10.70  # W4
$tmer  h/$f  co/$f  hcots/$f  x  -1  -1  1  $w  3.2
$tmer  hco/$f  hcots/$f    x  -1  1    $w  22.8
$tmer  h/$f  c2h4/$f  c2h5ts/$f  x  -1  -1  1  $w         1.83  # W4
$tmer  c2h5_1/$f  c2h5ts/$f    x  -1  1    $w            41.88  # W4
$tmer  ch3/$f  c2h4/$f  c3h7ts/$f  x  -1  -1  1  $w  6.4
$tmer  c3h7/$f  c3h7ts/$f    x  -1  1    $w  33.0
$tmer  hcn/$f  hcnts/$f    x  -1  1    $w                48.14  # W4
$tmer  hnc/$f  hcnts/$f    x  -1  1    $w                32.92  # W4
...
$tmer  oh/$f  CH4/$f  RKT04/$f  x  -1  -1  1  $w          6.13  # W4
$tmer  H2O/$f  ch3/$f  RKT04/$f  x  -1  -1  1  $w        19.36  # W4
...
$tmer  h/$f  oh/$f  RKT14/$f  x  -1  -1  1  $w           10.65  # W4
$tmer  H2/$f  O/$f  RKT14/$f  x  -1  -1  1  $w           12.90  # W4
$tmer  h/$f  H2S/$f  RKT16/$f  x  -1  -1  1  $w           3.77  # W4
$tmer  H2/$f  HS/$f  RKT16/$f  x  -1  -1  1  $w          17.09  # W4
