...
def get_molecules_from_filesystem(verbosity: int) -> dict[str, list[Molecule]]:
    """
    Get a list of molecules from the filesystem.
    """
    gmtkn55_mols: dict[str, list[Molecule]] = {}

    # loop over all directories in the GMTKN55_DIRS
    for dir_name in GMTKN55_DIRS:
